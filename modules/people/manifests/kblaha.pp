# Replace name of all the "kblaha" with your github username
...
class people::kblaha {
  ...
  #if you do not copy these your dotfiles will change when this kblaha profile is updated as they
