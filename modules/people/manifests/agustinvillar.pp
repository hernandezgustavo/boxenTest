# Replace name of all the "agustinvillar" with your github username
# if you have a dash (-) in your username use an underscore (_) instead
class people::agustinvillar {
  ...
  #  license => "${$boxen::config::repodir}/modules/people/files/agustinvillar/LICENSE_FILENAME.lic"
  #}
  ...
  # if you do not copy these your dotfiles will change when this agustinvillar profile is updated as they
